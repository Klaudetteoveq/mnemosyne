...
scp "$LOCAL_SERVER/app/embedding.py" "${SshHost}:${RemoteDir}/app/embedding.py"
scp "$LOCAL_SERVER/app/llm.py" "${SshHost}:${RemoteDir}/app/llm.py"
scp "$LOCAL_SERVER/app/chunking.py" "${SshHost}:${RemoteDir}/app/chunking.py"
